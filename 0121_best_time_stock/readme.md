...
Ключевая мысль: **когда мы стоим на дне `j`, нас интересует только самый дешёвый день до него, не позже.** Значит можно идти слева направо и просто запоминать минимум на ходу.
